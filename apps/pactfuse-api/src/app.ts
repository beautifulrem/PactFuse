      ...
      schemas: {
        ...
        PublicClaimResponse: serviceResponseSchema({
          ...
          properties: {
            ...
            snapshotScope: { const: "authorization_event" },
            providerSnapshotOnly: { const: true },
            authorizedAt: { type: "string", format: "date-time" },
            authorizedEventSeq: { type: "integer", minimum: 1 },
        ...
        LeaseExecuteResponse: serviceResponseSchema({
          ...
          properties: {
            ...
            payer: { type: "string", pattern: "^0x[0-9a-fA-F]+$" },
            artifactHash: { type: "string", pattern: "^0x[0-9a-fA-F]{64}$" },
            consumedArtifactPayloadHash: { anyOf: [{ type: "string", pattern: "^0x[0-9a-fA-F]{64}$" }, { type: "null" }] },
            bearerBound: { const: true },
