...
const STR = {
  en: {
    ...
    "head.proof1b": "CAW authorizes", "head.proof1s": "owner-bound spend rail",
    "head.proof2b": "Gate interrupts", "head.proof2s": "unsafe source before payment",
    "head.proof3b": "Receipt proves", "head.proof3s": "{n} judge checks", "head.proof3sFixture": "fixture mode only",
  ...
  zh: {
    ...
    "head.proof1b": "CAW 授权", "head.proof1s": "owner 绑定的支付轨",
    "head.proof2b": "闸门熔断", "head.proof2s": "付款前拦截不安全来源",
    "head.proof3b": "回执自证", "head.proof3s": "{n} 项 judge 校验", "head.proof3sFixture": "仅 fixture 模式",
