...
const STR = {
  en: {
    ...
    "sc.trip.s3d": "the payment path for every spend pinned to that source is opened",
  ...
  zh: {
    ...
    "sc.trip.s1d": "挑战证据进入本 session 账本",
    "sc.trip.s2d": "indexer 确认这条公链风险事件",
    "sc.trip.s3d": "凡是钉住该来源的支付,其付款路径都被打开",
    "sc.settle.s1d": "在 Pact 策略边界内签署 ERC20 approval",
    "sc.settle.s2d": "额度 {a} → {b} @ 区块 {n}",
    "sc.settle.s3d": "SpendSettled 已最终确认 · 市场余额 {a} → {b}",
    "sc.settle.s4d": "bearer 绑定的访问令牌;MCP transcript 钉定到买到的 artifact",
    ...
    "drawer.chainState": "链上实时状态", "drawer.chainStateSub": "从已部署合约实时读取(keyless)",
    ...
    "cs.probeH": "自查任意来源的新鲜度", "cs.probeBtn": "读取状态", "cs.invalid": "请输入 0x 开头的 32 字节 source hash",

    "help.title": "键盘快捷键",
    "help.r1": "选择风险场景", "help.r2": "运行 / 重试场景",
    "help.r3": "清空证据日志", "help.r4": "复位到空闲",
    "help.r5": "Judge 校验 · 证明哈希 · 自检 · 实时状态", "help.r6": "切换本帮助", "help.r7": "关闭",
